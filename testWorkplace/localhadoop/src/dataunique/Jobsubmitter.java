...
public class Jobsubmitter {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		// TODO Auto-generated method stub
			...
			Job job = new Job(conf, "1j-Dedup");//job_name = "wordcount"    
			 job.setJarByClass(Jobsubmitter.class);//输入    

		     

			 job.setMapperClass(DedupMapper.class);  //输入  
			 job.setReducerClass(DedupReducer.class);   //输入
			 ...
			 FileOutputFormat.setOutputPath(job, new Path("hdfs://master:9000/1j/output-Decup-1"));//输出文件    
