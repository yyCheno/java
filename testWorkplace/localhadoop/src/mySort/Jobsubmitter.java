	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		// TODO Auto-generated method stub
			...
			Job job = new Job(conf, "1j-MySort");//job_name = "wordcount"    
			 ...
			 job.setMapperClass(MySortMapper.class);  //输入  
			 job.setReducerClass(MySortReducer.class);   //输入
			 job.setOutputKeyClass(IntWritable.class);    //输出
			 ...
			 FileInputFormat.addInputPath(job, new Path("D://something/sort.txt"));//输入文件，端口默认9000，具体看集群配置
			 FileOutputFormat.setOutputPath(job, new Path("D://something/sortout"));//输出文件    
